...
public class spriority {
	...
	spriority(int agingscore,ArrayList<Integer> ArrivalTime,ArrayList<Integer> BurstTime,ArrayList<String> processesname,ArrayList<Integer> priorities){
	...
	public void Dopriority() {
		...
		while(true) {
			//increase priority in all the waiting queue
            for(int i=0;i<waitingqueueindex.size();i++) {
            	waitingqueuepriority.set(i, waitingqueuepriority.get(i)-agingscore);
            }
